 ...
 * This file demonstrates how to integrate Toneurn with a web frontend
 */

// For React/Vue/Angular applications
export class ToneurnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ToneurnClient(provider, contractAddress);
